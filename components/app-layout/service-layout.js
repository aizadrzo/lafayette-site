  ...
  return (
    <div className="container max-w-screen-xl mx-auto pt-4 px-4 md:px-8">
      <div className="max-w-lg">
        <h3 className="text-gray-800 text-2xl font-bold">Insurance Services</h3>
              ...
              <div className="space-y-5 md:space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-lg text-gray-600">
                    ...
                    and we only recommend policies that make sense for you based
                    on your own opinion and depending on your situation.
                    ...
                    companies. We focus on everything from a tornado to a thief
                    and will make sure you can go about your day-to-day life
                    worry-free.
                  </p>
                </div>
              </div>
